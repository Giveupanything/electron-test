...
import { ReplayLine } from '@/components/icon/communication';
  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="mb-1 h-8 line-clamp-2 system-xs-medium text-text-tertiary break-all text-xs cursor-pointer"
          title={name}
