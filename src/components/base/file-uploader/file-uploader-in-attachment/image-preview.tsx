...
const ImagePreview: FC<ImagePreviewProps> = ({
  ...
  return createPortal(
    ...
    >
      ...
      />
      <Tooltip popupContent="复制图片">
        <div
          className="absolute top-6 right-48 flex items-center justify-center w-8 h-8 rounded-lg cursor-pointer"
          onClick={imageCopy}
        >
          {isCopied
      ...
      <Tooltip popupContent="缩小">
        <div
          className="absolute top-6 right-40 flex items-center justify-center w-8 h-8 rounded-lg cursor-pointer"
          onClick={zoomOut}
        >
          <RiZoomOutLine className="w-4 h-4 text-gray-500" />
        </div>
      </Tooltip>
      <Tooltip popupContent="放大">
        <div
          className="absolute top-6 right-32 flex items-center justify-center w-8 h-8 rounded-lg cursor-pointer"
          onClick={zoomIn}
        >
          <RiZoomInLine className="w-4 h-4 text-gray-500" />
        </div>
      </Tooltip>
      <Tooltip popupContent="下载">
        <div
          className="absolute top-6 right-24 flex items-center justify-center w-8 h-8 rounded-lg cursor-pointer"
          onClick={downloadImage}
        >
          <RiDownloadCloud2Line className="w-4 h-4 text-gray-500" />
        </div>
      </Tooltip>
      <Tooltip popupContent="在新标签页打开">
        <div
