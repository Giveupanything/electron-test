import { CitationItem } from '@/axios/type';
import { RiArrowDownSLine } from '@remixicon/react';
import { useEffect, useMemo, useRef, useState } from 'react';
import CitationPopup from './popup';
  ...
  const handleAdjustResourcesLayout = () => {
    ...
    for(let i = 0; i < resources.length; i++) {
      ...
      if(totalWidth + i * 4 > containerWidth!) {
        ...
        if(totalWidth + 34 > containerWidth!) setLimitNumberInOneLine(i - 1);
        else setLimitNumberInOneLine(i);
