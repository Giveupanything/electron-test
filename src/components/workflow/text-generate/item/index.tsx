...
const GenerationItem: FC<IGenerationItemProps> = ({
  ...
  return (
    <div
      ref={ref}
      className={cn(isTop ? `rounded-xl border ${!isError ? 'border-gray-200 bg-chat-bubble-bg' : 'border-[#FECDCA] bg-[#FEF3F2]'} ` : 'rounded-br-xl !mt-0', className)}
      style={isTop
        ? {
          ...
          >
            ...
            <div className="flex items-center justify-between mt-3">
              <div className="flex items-center">
                ...
                {supportAnnotation && (
                  <>
                    <div className="ml-2 mr-1 h-[14px] w-[1px] bg-gray-200" />
                    <AnnotationCtrlBtn
                      appId={appId!}
                      messageId={messageId!}
                      className="ml-1"
