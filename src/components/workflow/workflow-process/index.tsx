...
import type { ChatItem, WorkflowProcess } from '@/types/app';
import TracingPanel from '@/components/workflow/workflow-process/tracing-panel';
import cn from '@/utils/classnames';
import { CheckCircle } from '@/components/icon/communication';
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className={cn('system-xs-medium text-text-secondary text-xs', !collapse && 'grow')}>
          工作流
        </div>
