...
import { languageMap } from '../code-editor/index';
import { generateRuleCode } from '@/api/text';
import type { CodeGenRes } from '@/types/app';
...
import type { CodeLanguage } from '@/types/app';
import { useModelListAndDefaultModelAndCurrentProviderAndModel } from './hooks';
import { ModelTypeEnum } from '@/types/app';
