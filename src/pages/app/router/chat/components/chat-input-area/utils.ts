...
import { FileAppearanceTypeEnum, FileEntity } from '../../types';
import { FILE_EXTS, SupportUploadFileTypes } from './constants';
import { FileResponse } from '@/utils/utils';
...
type FileUpload = (v: FileUploadParams, apiKey: string, url?: string) => void
